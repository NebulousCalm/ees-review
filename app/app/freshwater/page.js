    ...
    return (
        ...
        <div className="container">
            <div className="header-container">
                ...
                <Link href="https://ecology.wa.gov/water-shorelines/water-quality/groundwater/groundwater-resources/groundwater-diagram"><div className="header-image freshwater"></div></Link>
            </div>
            ...
            <div className="article-container">
                ...
                <p className="paragraph">Freshwater can also be infeced. Here in North Carolina it&apos;s a prevalent problem. Hog waste being the most significant contributor causes Eutrophication. Eutrophication being the main cause of river ecosystems being in danger today. First, fertilizer runoff enters the water source. Algae within, grows rapidly. Causing a algae film to form. Preventing sunlight to enter and for the plant life underneath to create oxygen via photosynthesis. Because of the lack of oxygen in the water all life ceases to exist.</p>
                <p className="paragraph">Out of most units in Earth and Environmental Science, this is probably the most important to me. As I am currently designing a method of obtaining river/stream data (Dissolved oxygen, water levels, light levels, etc.) So understanding how water moves and is used throughout our lives is vital to me creating this product and it will be used to great use.</p>
            </div>
        </div>
